...
namespace DevXuongMoc.Areas.Admins.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderId,CustomerId,TotalAmount")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,CustomerId,TotalAmount")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
