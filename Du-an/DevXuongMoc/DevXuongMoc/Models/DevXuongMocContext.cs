...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DELL\\WIBULORD;Database=DevXuongMoc;uid=sa;pwd=1234567;MultipleActiveResultSets=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AdminLog>(entity =>
        {
            entity.HasKey(e => e.LogId).HasName("PK__ADMIN_LO__4364C8826DF36D80");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__CUSTOMER__3214EC07CF08E422");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__PARTNER__3214EC2714D5B89B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SLIDES__3214EC2750F96484");
